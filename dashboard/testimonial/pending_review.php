<?php 
    ...
    $review_query_result = mysqli_query($db_connect,"SELECT * FROM reviews WHERE status=0");
            ...
            <div class="col-md-6">
                <div class="media m-v-10">
                    ...
                    <div class="media-body m-l-15">
                        <h6 class="mb-0">Pending Review (<?=(mysqli_num_rows($review_query_result))?>)</h6>
                                        ...
                                        ?>
                                                            <tr>
                                                                ...
                                                                <?php 
                                                                    ...
                                                                    ?>
                                                                        <a href="/approve-review/<?=($encoded_review_id)?>" class="btn btn-primary btn-tone">
                                                                        <i class="anticon anticon-check"></i>
                                                                        </a>
                                                                        <a href="/user-profile/<?=($encoded_review_id)?>" class="btn btn-primary btn-tone">
                                                                            <i class="anticon anticon-idcard"></i>
                                                                        </a>
                                                                        <a id="/delete-review/<?=($encoded_review_id)?>/pending" class="btn btn-primary btn-tone pending_del_btn text-danger" style="cursor:pointer">
                                                                    ...
                                                                    ?>
                                                                            ...
                                                                            <a id="/delete-review/<?=($encoded_review_id)?>/pending" class="btn btn-primary btn-tone pending_del_btn">
                                                                            <i class="anticon anticon-delete"></i>
                                                                            </a>
                                                                    <?php            
                                                                            }
...
<script>
    $('.pending_del_btn').click(function(){
        Swal.fire({
        title: 'Are you sure?',
