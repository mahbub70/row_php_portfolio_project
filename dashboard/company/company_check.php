<?php 
    ...
    if(isset($_POST['about_submit']) || isset($_POST['service_header_submit']) || isset($_POST['portfolio_header_submit'])){
        ...
        }elseif(strlen($small_title) > 20){
            $errors['small_title'] = "Small Title Contains <strong>Maximum 20 Characters</strong>.";
        }
        ...
        }elseif(strlen($big_title) > 50){
            $errors['big_title'] = "Big Title Contains <strong>Maximum 50 Characters</strong>.";
        }
