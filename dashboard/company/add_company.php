...
<div class="main-content">
    <div class="page-header">
        <h2 class="header-title">Add About Information</h2>
        ...
        <div class="col-md-8 m-auto">
            <div class="card" style="border:1px solid #ddd">
                <div class="card-body">
                    ...
                    <form action="/check-about/add" method="POST" enctype="multipart/form-data">
                        <div class="form-group">
                            <label for="formGroupExampleInput">Small Title</label>
                            <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Enter Small Title" name="small_title" value="<?=(isset($_SESSION['old_values']['small_title'])?($_SESSION['old_values']['small_title']):(''))?>">
                            <?php 
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="formGroupExampleInput2" placeholder="Enter Big Title" name="big_title" value="<?=(isset($_SESSION['old_values']['big_title'])?($_SESSION['old_values']['big_title']):(''))?>">
                            <?php 
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" class="form-control" id="formGroupExampleInput2" placeholder="Enter About Text" name="about_text"><?=(isset($_SESSION['old_values']['about_text'])?($_SESSION['old_values']['about_text']):(''))?></textarea>
                            <?php 
                        ...
                        <button type="submit" name="about_submit" class="btn btn-primary">Add About</button>
                    </form>
                </div>
            </div>
        </div>
