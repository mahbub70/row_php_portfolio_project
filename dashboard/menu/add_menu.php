    ...
    if(isset($_POST['menu_submit'])){
        ...
        if(!isset($name_err) && !isset($link_err)){
            ...
            if(mysqli_num_rows($check_menu_result) == 0){
                $menu_insert_result = mysqli_query($db_connect,"INSERT INTO menu(name, link) VALUES ('$menu_name','$menu_link')");
                if($menu_insert_result){
...
<div class="main-content">
    <div class="page-header">
        <h2 class="header-title">Add New Menu</h2>
            ...
            <div class="card" style="border:1px solid #ddd">
                <div class="card-body">
                    ...
                    <form action="" method="POST">
                        ...
                        <button type="submit" name="menu_submit" class="btn btn-primary">Create</button>
                    </form>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-6 m-auto">
                <div class="card" style="border:1px solid #ddd">
                    <div class="card-body">
                        ...
                        ?>
                            <div class="btn btn-default mb-2"><?=($menu_row_array['name'])?></div>
                        <?php           
                            }
                        ?>
