...
###################### Query For Login Client Review START #########################
$review_query_result = mysqli_query($db_connect,"SELECT * FROM reviews WHERE client_id=$login_user_id");
            ...
            <div class="col-md-6">
                <div class="media m-v-10">
                    ...
                    <div class="media-body m-l-15">
                        <h6 class="mb-0">My Reviews (<?=(mysqli_num_rows($review_query_result))?>)</h6>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-right">
                                                                    ...
                                                                    <?php 
                                                                        if($review_row_array['status'] == 0){
                                                                    ?>
                                                                        <a id="/delete-review/<?=($encoded_review_id)?>/client-dashboard" class="btn btn-primary btn-tone review_del_btn text-danger" style="cursor:pointer">
