...
<div class="main-content">
    <div class="page-header">
        <h2 class="header-title">Add Service</h2>
    ...
    <div class="container">
        <div class="col-md-8 m-auto">
            <div class="card" style="border:1px solid #ddd">
                <div class="card-body">
                    <form action="/check-feature/add-service" method="POST" enctype="multipart/form-data">
                        <div class="form-group">
                            <label for="formGroupExampleInput">Service Title</label>
                            <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Service Title" name="title" value="<?=(isset($_SESSION['old_values']['title'])?($_SESSION['old_values']['title']):(''))?>">
                            <?php 
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" class="form-control" id="formGroupExampleInput2" placeholder="Service Description" name="desc"><?=(isset($_SESSION['old_values']['desc'])?($_SESSION['old_values']['desc']):(''))?></textarea>
                            <?php 
                        ...
                        <button type="submit" name="service_submit" class="btn btn-primary">Add Service</button>
                    </form>
                </div>
            </div>
        </div>
